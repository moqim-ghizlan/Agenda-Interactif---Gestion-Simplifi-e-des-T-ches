...
<body>
    <form action="done.php" method="POST" class="add_form">
        ...
        <div class="top">
            <spam>Chossisez le type de controle</spam>
            <select name="type">
                <option value="dc">DS</option>
        ...
        <div class="bottom">
            <textarea rows="10" cols="40" placeholder="Ajouter une note sur le contole :" name="note"></textarea><br>
            <input type="date" value="<?php echo date('Y-m-d')?>"max="2025-1-1" name="date"><br>
            <input type="hidden" name="type_added" value="controle"/>
