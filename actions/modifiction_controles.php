...
<div class="info_acc">
        <h3><?php
        echo '
        <h2>Vous tentez de modifer le devoir de <spam class="spam_info">'.$_POST['controle_info1'].'</spam>, de type  <spam class="spam_info">'.$_POST['controle_info4'].'</spam>, qui aura lieu le <spam class="spam_info">'.$_POST['controle_info3'].'</spam></h2>
        ';
        ?></h3>
        </div>
        <div class="top">
        ...
        <input type="hidden" name="type_action" value="controle" />
